...
setwd("/Users/lucy/Desktop/Imperial/Winter/Valewood Preparation/Valewood 2/Data/Data_f/")
...
# With two furthest points removed
tea_r_ED_2 <- tea_r_ED %>% filter(Distance<1.6)
lm_r_ED_2 <- lmer(k ~ Distance + (1|Replicate), data = tea_r_ED_2)
summary(lm_r_ED_2)
Anova(lm_r_ED_2, test.statistic = "F")
